...
![git文件系统](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/Git文件系统-1.png)

可以看到.git文件夹下已经有很多内容，相关介绍如下图所示：

![git_file](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/git_file.png)
...
![git底层命令](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/底层命令-1.png)

了解底层命令可以让我们更直观的理解git的工作原理，比如我们平时操作的`git add & git commit`其实可以用底层命令实现，如下：

![git commit](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/commit_command.png)
...
![git对象](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/git对象-1.jpg)
...
![git object](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/git_object.png)

上图主要使用底层命令`cat-file`获取对象信息，首先用`-p`选项打印对象中文件的内容，然后用`-t`打印对象类型。可以看到首先打印的是blob类型，也就是数据对象的内容，然后是树对象内容，最后是提交对象的内容，这里可以看到tree就是我们当时提交时使用的树对象的键值。下面为具体格式介绍：

![git object2](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/git_object2.png)

这里为什么没有tag对象，因为tag对象内容就是我们使用`git tag *`时标签的commit id，如下图：

![git tag](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/git_tag.png)
...
![refs](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/git_refs.png)
...
![packet](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/git_packet.png)
...
![git_fs](https://cdn.jsdelivr.net/gh/gewuang/cloudimg/data/git_fs.png)
